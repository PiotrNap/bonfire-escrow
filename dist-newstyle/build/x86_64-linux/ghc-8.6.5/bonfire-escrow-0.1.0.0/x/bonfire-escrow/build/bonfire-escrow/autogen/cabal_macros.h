...
/* package bonfire-escrow-0.1.0.0 */
#ifndef VERSION_bonfire_escrow
#define VERSION_bonfire_escrow "0.1.0.0"
#endif /* VERSION_bonfire_escrow */
#ifndef MIN_VERSION_bonfire_escrow
#define MIN_VERSION_bonfire_escrow(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_bonfire_escrow */
...
#define CURRENT_COMPONENT_ID "bonfire-escrow-0.1.0.0-inplace-bonfire-escrow"
